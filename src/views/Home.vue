  ...
  <div class="home">
    ...
    <div class="subsection">
      ...
      <div class="flex-parent">
        ...
        <div>
          <router-link :to="{ name: 'AddCompanySection', params: { appData: appData }}" class="add-company">Add New Company</router-link>
        </div>
      </div>
    </div>
    <div class="subsection">
      ...
      <div v-for="company in appData" v-bind:key="company.name" >
        <div v-if="company.isParticipating(user.uuid) && company.modules.length > 0">
          ...
          <div v-for="module in company.modules" v-bind:key="module.name">
            <div v-if="!module.hasBeenCompletedBy(user.uuid)">
